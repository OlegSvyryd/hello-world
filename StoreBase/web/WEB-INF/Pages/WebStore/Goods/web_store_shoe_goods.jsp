...
<div id="wrapper">
    ...
    <button id = "show-confirmed-orders" class="button" onclick="document.location.href='add_web_store_shoe_goods${web_store_id}'" style="margin-bottom: 10px!important">Додати новий товар</button>
    <button id = "show-confirmed-orders" class="button" onclick="document.location.href='web_store_shoe_reports${web_store_id}'" style="margin-bottom: 100px!important">Отримати звіти</button>
        ...
        <tr class = "editField">
            ...
            <td class="too-width">
                    ...
                    <c:choose>
                        ...
                        <c:when test="${not empty goods.image}">
                            <img width="200px;" style="max-height: 175px;" src="/imageControllerS/${goods.id}" alt="Image" />
                        </c:when>
                    </c:choose>
            ...
            <td>
                <input type="button" id = "updStore-field" value = "Редагувати"
                       onclick="document.location.href='update_web_store_shoe_goods${goods.id}'"/>
            </td>
            <td>
    ...
    $(document).on("click", "table .editField #delGoods-field", function() {
        ...
        swal({
            ...
            if (isConfirmed) {
                ...
                $.ajax({
                    url: "/del_web_store_goods_shoe_success",
                    type: "POST",
                    datatype: "json",
                    data: savedata,
                    error: function () {
