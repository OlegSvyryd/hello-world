...
<head>
    ...
    <title>StoreBase | Звіти компаній</title>
</head>
<body>
<div id="wrapper">
    ...
    <table id="stores-table">
        ...
        <tr>
            <th>
                <input type = "button" id = "oborot" onclick = "window.location.href='cmr${1}'" value = "Оборот">
            </th>
            <td>
        ...
        <tr>
            <th>
                <input type = "button" id = "store_statistics" onclick = "window.location.href='cmr${2}'" value = "Статистика">
            </th>
            <td>
                <p>Статистика по магазинах, які замовляли товари.</p>
            </td>
        </tr>
    </table>
